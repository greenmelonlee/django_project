...
SECRET_KEY = 'django-insecure-#j-txzb=cz4nzv%fxfjmt6+1-x*wmg31ce3fv)cns6*4yh*q6l'
...
# LOGIN_REDIRECT_URL = '/blog/post-list' # localhost:8000/login/account/blog/post-list
LOGIN_REDIRECT_URL = 'blog_app:post_list' # 로그인 성공시 본태줄 리다이렉트 주소
